...
class B24:
    def __init__(self):
        ...
        self.bx24 = Bitrix24("https://portal.emk.ru/rest/4949/7nv1yt72o9d8ne0f/")
    ...
    #     # url = 'https://test-portal.emk.ru/oauth/authorize/?
    #     # client_id=local.6936c2c4e28141.22464163&
    #     # redirect_uri=https%3A%2F%2Ftest-portal.emk.ru%2Fintranet%2Frest%2Fauthuser.php&
    #     # response_type=code&
    #     # state=test_1765265567&
    #     # scope=user'
    #     # url = 'https://test-portal.emk.ru/oauth/authorize/?
    #     # login=yes&client_id=local.6936c2c4e28141.22464163&
    #     # redirect_uri=https%3A%2F%2Ftest-portal.emk.ru%2Fintranet%2Frest%2Fauthuser.php&
    #     # response_type=code&
    ...
    def getUser(self, ID):
        self.bx24 = Bitrix24("https://portal.emk.ru/rest/4949/986zkbe8rqmgwpxp/")
        result = self.bx24.callMethod(f'user.get?ID={ID}')
        return result

    def getDeps(self):
        self.bx24 = Bitrix24("https://portal.emk.ru/rest/4949/yqc6df45ed0az15f/")
    ...
    def getInfoBlock(self, id):
        ...
        self.bx24 = Bitrix24("https://portal.emk.ru/rest/4949/9jw7puct7jq63b07/")
