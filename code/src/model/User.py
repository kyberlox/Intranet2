...
class User:
    ...
    async def anniversary_in_company(self, session):
        ...
        try:
            ...
            YEARS_ID = {'1': 7, "5": 8, "10": 9, "15": 10, "20": 11, "25": 12, "30": 13, "35": 14, "40": 15} # менять значеняи к годам если поменялись айдишники
            ...
            for i, user_inf in enumerate(all_users, start=2):
                ...
                if user_inf.active is True:
                    ...
                    if 'uf_department' in indirect_data:
                        ped_info = await UsDep(id=indirect_data['uf_department'][0]).search_dep_by_id(session)
                    ...
                    ws[f'G{i}'] = f'{uniq_visits['totals'][0]}'
