...
class Visions:
    ...
    async def delete_vision(self, session):
        ...
        await UservisionsRootModel(vision_id=self.vision_id).remove_users_from_vision(user_data=users_id, roots=roots, session=session)
    ...
    async def add_user_to_vision(self, user_to, session):
        ...
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id, user_id=user_to).upload_user_to_vision(roots=roots, session=session)
    ...
    async def add_full_usdep_list_to_vision(self, dep_id, session):
        ...
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id).upload_users_to_vision(roots=roots, user_data=all_dep_users, session=session)
    ...
    async def add_users_list_to_vision(self, users, session):
        ...
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id).upload_users_to_vision(user_data=users, roots=roots, session=session)

    async def delete_user_from_vision(self, user, session):
        root_init = RootsModel(user_uuid=self.user_id)
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id, user_id=user).remove_user_from_vision(roots=roots, session=session)
    
    async def delete_users_from_vision(self, users, session):
        root_init = RootsModel(user_uuid=self.user_id)
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id).remove_users_from_vision(user_data=users, roots=roots, session=session)
    ...
    async def remove_depart_in_vision(self, dep_id, session):
        ...
        roots_uuid = await root_init.get_token_by_uuid(session=session)
        roots = await root_init.token_processing_for_vision(roots_uuid)
        return await UservisionsRootModel(vision_id=self.vision_id).remove_depart_in_vision(dep_id=dep_id, roots=roots, session=session)
...
async def add_user_to_vision(request: Request, vision_id: int, user_id: int, session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
...
async def add_dep_users_only(request: Request, vision_id: int, dep_id: int, session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
...
async def add_full_usdep_list_to_vision(request: Request, vision_id: int, dep_id: int, session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
    return await Visions(vision_id=vision_id, user_id=uuid).add_full_usdep_list_to_vision(dep_id=dep_id, session=session)

@fieldsvisions_router.put("/add_users_list_to_vision/{vision_id}")
async def add_users_list_to_vision(request: Request, vision_id: int, users = Body(), session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
...
async def delete_user_from_vision(request: Request, vision_id: int, user_id: int, session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
...
async def delete_users_from_vision(request: Request, vision_id: int, users = Body(), session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
...
async def remove_depart_in_vision(request: Request, vision_id: int, dep_id: int, session: AsyncSession=Depends(get_async_db)):
    uuid = await get_uuid_from_request(request, session)
