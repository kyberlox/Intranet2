    ...
    def send_to_new_wrokers(self):
        try:
            ...
            text_msg = f'<p>Дорогой(ая) коллега!</p>\
                        ...
                        <p>В знак приветствия на Ваш счёт «Капитал ЭМК» зачислены стартовые баллы. 
    ...
    def send_to_birthday_notifications(self):
        try:
            ...
            text_msg = f'<p>Дорогой(ая) коллега!</p>\
                        ...
                        <p>В знак внимания мы зачислили на Ваш счёт в «Капитал ЭМК» подарочные баллы. 
    ...
    def send_to_anniversary_in_company(self, year):
        try:
            ...
            text_msg = f'<p>Дорогой(ая) коллега!</p>\
                        ...
                        <p>В знак благодарности за Ваш стаж на счёт «Капитал ЭМК» зачислены баллы. 
    ...
    def send_to_jubilee_in_company(self, year):
        try:
            ...
            text_msg = f'<p>Дорогой(ая) коллега!</p>\
                        ...
                        <p>В честь юбилея на Ваш счёт «Капитал ЭМК» зачислено особое вознаграждение. 
