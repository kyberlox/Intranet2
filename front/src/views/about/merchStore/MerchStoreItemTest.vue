    ...
    <div class="merchStoreItem__wrapper">
        <div class="merchStoreItem mt20">
            <div class="merchStoreItem__images__wrapper">
                ...
                <!-- <div class="merchStoreItem__images__image">
                    <img :src="merchItemPlug.images[0]" />
                </div> -->
                <SwiperBlank :images="merchItemPlug.images" />
            </div>
...
.merchStoreItem {
    ...
    .merchStoreItem__images__wrapper>.swiper>.swiper-wrapper>.swiper-slide {
        aspect-ratio: auto;
