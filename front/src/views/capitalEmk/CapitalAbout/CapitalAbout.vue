...
<div class="mt20">
    ...
    <div v-if="myId"
        ...
        <span>
            ...
            баллов. Магазин мерча начал свою работу с <strong>03.02.2026</strong>. Баллы за события, которые у Вас были до 03.02.2025 не
            начисляются.
            <br />
            ...
            <ul>
                <li>
                    обратитесь к нам (тел. 1203 или на почту merch.store@emk.ru) - мы поможем внести корректную дату
                </li>
                <li>
